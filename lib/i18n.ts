...
export const translations = {
  en: {
    ...
    saTitle: 'Vonage Silent Authentication',
    saTagline: 'Verify without friction',
    saDesc: 'Authenticate users instantly by leveraging the mobile network — no OTPs, no passwords, no user action required. Reduce fraud and drop-off in onboarding and login flows.',
    saBenefit1: 'Protection without passcodes — zero user friction',
    saBenefit2: 'Mobile network-level authentication in milliseconds',
    saBenefit3: 'Eliminates OTP interception and SIM swap vulnerabilities',
    saBenefit4: 'Seamless integration via a single API call',
