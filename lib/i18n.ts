...
export const translations = {
  en: {
    ...
    iiTagline: 'Network-powered fraud intelligence',
    iiDesc: 'Leverage real-time mobile network signals — pulled directly from carrier infrastructure via CAMARA/Open Gateway — to detect SIM swaps, verify numbers, validate subscriber identity, and assess fraud risk. Intelligence that application-layer solutions cannot access.',
    iiBenefit1: 'SIM Swap Detection: flag recent SIM changes to block account takeover in real time',
    iiBenefit2: 'Number Verification: confirm device-to-number binding silently via the network',
    iiBenefit3: 'Subscriber Match: validate identity against mobile operator KYC data',
    iiBenefit4: 'Carrier ID & Number Format: screen numbers, detect virtual/burner phones, clean databases',
