...
export const translations = {
  en: {
    ...
    solutionNaDesc: 'Leverage mobile network intelligence directly — SIM swap detection, number verification, and device location — powered by carrier-grade data.',
    ...
    naTagline: 'Carrier-grade intelligence at your fingertips',
    naDesc: 'Vonage Network APIs tap directly into mobile operator infrastructure to deliver real-time signals that application-layer solutions cannot access. Built on CAMARA/Open Gateway standards, these APIs let you verify devices, detect SIM swaps, and confirm location — all without user interaction.',
    naBenefit1: 'SIM Swap API: detect recent SIM changes to block account takeover in real time',
    naBenefit2: 'Number Verification: confirm device-to-number binding silently via the network',
    naBenefit3: 'Device Location: verify user proximity for high-risk transactions',
    naBenefit4: 'Built on CAMARA/Open Gateway — carrier-grade, globally scalable',
